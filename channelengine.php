...
class Channelengine extends Module
{
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'name' => 'CHANNELENGINE_ACCOUNT_EMAIL',
                        'label' => $this->l('Email'),
                    ),
                    array(
                        'type' => 'password',
                        'name' => 'CHANNELENGINE_ACCOUNT_PASSWORD',
    ...
    {
        return array(
            'CHANNELENGINE_LIVE_MODE' => Configuration::get('CHANNELENGINE_LIVE_MODE', true),
            'CHANNELENGINE_ACCOUNT_EMAIL' => Configuration::get('CHANNELENGINE_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'CHANNELENGINE_ACCOUNT_PASSWORD' => Configuration::get('CHANNELENGINE_ACCOUNT_PASSWORD', null),
        );
    }
